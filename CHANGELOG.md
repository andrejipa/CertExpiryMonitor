...
- **BugHunt com automacao direta da UI**: o fluxo maximo aciona `Ver detalhes` e `Fechar aviso` via UI Automation, verifica instancia unica e rejeita popup duplicado.
